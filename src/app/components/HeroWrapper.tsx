...
const HeroWrapper: FC<
  PropsWithChildren & BaseHTMLAttributes<HTMLBaseElement>
> = ({ children, className }) => {
  return (
    <div
      className={twMerge(
        'bg-[url("/noise.png")] bg-center bg-secondary min-h-screen relative overflow-hidden flex',
        className
      )}
    >
      {children}
      <svg
        className="absolute bottom-[-350px] w-[4000px] mix-blend-color"
